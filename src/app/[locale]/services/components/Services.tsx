...
export default function Services() {
  ...
  return (
    ...
    <div className='grid grid-cols-2 md:grid-cols-4 max-md:text-center gap-2 items-center max-md:pr-3'>
    ...
    <div className='grid grid-cols-2 md:grid-cols-4 gap-2 text-center items-center'>
      <span className='flex-nowrap bg-blue-200/25 text-blue border   border-blue rounded-2xl py-1 px-4'>{t('service.usine')}</span> 
       ...
       <span className='flex-nowrap bg-blue-200/25 text-blue border border-blue rounded-2xl py-1 px-4'>{t('service.zone')}</span>
    </div>
    </div>
  </div> 
        </div>
    ...
    <div className='flex flex-col gap-2'>
      <h3 className='font-semibold text-blue text-[16px] font-base leading-6'>{t('service.desservis')}</h3>
    <div className='grid grid-cols-2 text-center md:grid-cols-4 gap-2 items-center'>
