      ...
      <section data-aos='slide-up'>
        <div className='grid max-w-6xl mx-auto place-items-center gap-5 p-6'>
          <div className='flex flex-col items-center gap-3'>
            <span className="bg-[rgba(138,28,90,0.15)] font-semibold text-[12px] text-gray rounded-2xl px-3 py-1">{t('home.temoignages')}</span>
            <h2 className='md:text-5xl text-2xl font-header text-center font-extrabold text-blue'>{t('home.confiance')}</h2>
            <p className='font-base text-lg text-gray'>{t('home.confiance.text')}</p>
