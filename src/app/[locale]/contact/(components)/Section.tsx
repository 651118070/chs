        ...
        <main className='bg-blue20'>
            <section data-aos='slide-up' className='grid max-w-6xl mx-auto gap-5 p-6 mt-20'>
                <div className='flex items-center gap-5 flex-col'>
                    <h1 className='text-blue text-nowrap font-header md:text-5xl text-2xl font-extrabold leading-12'>{t('contact.header')}-<span className='text-violet font-header md:text-5xl text-2xl font-extrabold leading-12 '>{t('contact.us')}</span></h1>
